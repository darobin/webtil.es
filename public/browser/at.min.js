...
var titleChangeHandler = (ev) => setTitle(ev.title);
...
customElements.define("atmos-browser", class AtmosBrowser extends i4 {
  ...
  render() {
    ...
    if (this.#error.value) body = b2`<div class="error">${this.#error.value}</div>`;
      ...
      body = b2`<atmos-profile-card .profile=${this.#profile.value}>
...
// public/browser/el/profile-card.js
...
customElements.define("atmos-profile-card", class AtmosProfileCard extends i4 {
  static properties = {
...
customElements.define("atmos-tile-card", class AtmosTileCard extends i4 {
  ...
  render() {
    ...
    return b2`<div id="card" @click=${this.handleClick}>
