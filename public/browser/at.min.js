...
var require_StoreController = __commonJS({
  "node_modules/@nanostores/lit/lib/StoreController.js"(exports) {
    ...
    exports.StoreController = StoreController4;
  }
});
...
async function did2pds(did) {
  ...
  const pds = doc.service?.find((s4) => s4.id === "#atproto_pds")?.serviceEndpoint;
  return pds;
}
...
var atom = /* @__NO_SIDE_EFFECTS__ */ (initialValue) => {
  ...
  let $atom = {
    ...
    listen(listener) {
      ...
      return () => {
        for (let i5 = lqIndex + QUEUE_ITEMS_PER_LISTENER; i5 < listenerQueue.length; ) {
          if (listenerQueue[i5] === listener) {
            listenerQueue.splice(i5, QUEUE_ITEMS_PER_LISTENER);
          } else {
            i5 += QUEUE_ITEMS_PER_LISTENER;
          }
        }
...
var import_lit4 = __toESM(require_lib(), 1);
...
var import_lit6 = __toESM(require_lib(), 1);
